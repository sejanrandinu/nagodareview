  ...
  async do(name, configOrCallback, callback) {
    ...
    let doWrapper = async (doWrapperClosure) => {
      ...
      try {
        ...
        forceStepTimeout ? result2 = await timeoutPromise() : replaceResult ? result2 = replaceResult : result2 = await Promise.race([
        ...
        try {
          await this.#state.storage.put(valueKey, { value: result2 });
        } catch (e) {
...
`)[1];
  ...
  async attemptRestart() {
    this.ctx.storage.sql.exec("DELETE FROM states"), this.ctx.storage.sql.exec("DELETE FROM priority_queue");
